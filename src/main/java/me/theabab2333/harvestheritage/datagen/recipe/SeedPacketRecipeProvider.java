...
public class SeedPacketRecipeProvider extends ModRecipeProvider {
    ...
    protected void buildRecipes() {
        output.accept(
            ResourceKey.create(Registries.RECIPE, HarvestHeritage.of("seed/seedpacket/generic")),
            new SeedPacketRecipe(
                new Recipe.CommonInfo(false),
                new CraftingRecipe.CraftingBookInfo(CraftingBookCategory.MISC, ""),
                Ingredient.of(ModItems.KNOWN_SEED),
                Ingredient.of(Items.PAPER),
                new ItemStackTemplate(ModItems.SEED_PACKET.asItem(), 1, DataComponentPatch.EMPTY)
            ),
            null
        );
    }
